...
# Path details
src_img_path = "/Users/sriramshashank/.gemini/antigravity-ide/brain/24c62fb7-0e33-4b34-bc64-505e25575d1c/media__1779450977692.png"
dst_c_path = "/Users/sriramshashank/Documents/GitHub/hellojimny/waveshare_esp32s3_1.43_amoled_lvgl8/ui_img_godzilla.c"
...
def convert_image():
    ...
    with open(dst_c_path, 'w') as f:
        ...
        f.write("#endif\n\n")
        f.write(f"// IMAGE DATA: Godzilla (180x180 px)\n")
        f.write(f"const LV_ATTRIBUTE_MEM_ALIGN uint8_t ui_img_godzilla_data[] = {{\n")
        ...
        f.write("};\n\n")
        f.write("const lv_img_dsc_t ui_img_godzilla = {\n")
        f.write("    .header.always_zero = 0,\n")
        f.write(f"    .header.w = {W},\n")
        f.write(f"    .header.h = {H},\n")
        f.write("    .data_size = sizeof(ui_img_godzilla_data),\n")
        f.write("    .header.cf = LV_IMG_CF_TRUE_COLOR_ALPHA,\n")
        f.write("    .data = ui_img_godzilla_data\n")
        f.write("};\n")

    print(f"Successfully converted Godzilla PNG to C-array at {dst_c_path}")
